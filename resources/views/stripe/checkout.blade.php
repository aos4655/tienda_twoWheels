        ...
        <div class='row'>
            ...
            <div class='col-md-12'>
                <div class="card">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5" style="text-align:right;"><h3><strong>Total $1000</strong></h3></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="text-align:right;">
                                ...
                                <input type='hidden' name="productname" value="Asus Vivobook 17 Laptop - Pepinillos con canela">
                                <input type='hidden' name="total2" value="123">
                                <input type='hidden' name="productname2" value="Cafe Afroodisiaco">
