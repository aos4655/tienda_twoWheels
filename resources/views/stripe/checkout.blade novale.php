        ...
        <div class="flex h-full flex-col justify-center">
            ...
            <div class="mx-auto py-7 w-full max-w-2xl rounded-3xl   dark:bg-blue-800 shadow-lg">
                ...
                <div class=" p-3">
                    <table class="w-11/12 mx-auto table-auto  ">
                        ...
                        <tbody class=" text-sm text-white">
                            <!-- record 1 -->
                            <tr>
                                <td class="p-2 flex flex-row justify-start items-center border dark:border-green-50">
                                    <div>
                                        <img class="w-12 h-12" src="{{ Storage::url('imgProduct/6634dea5ce4a7.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="font-medium ml-4 ">Samsung Galaxy Note 4</div>
                                </td>
                                <td class="p-2 border dark:border-green-50 ">
                                    <div class="text-center">1</div>
                                </td>
                                <td class="p-2 border dark:border-green-50">
                                    <div class="text-right w-24 font-medium "> 2,890.66 €</div>
                                </td>
                                <td class="p-2 border dark:border-green-50">
                            ...
                            <!-- record 2 -->
                            <tr>
                                <td class="p-2 border dark:border-green-50 flex flex-row justify-start items-center">
                                    <div>
                                        <img class="w-12 h-12" src="{{ Storage::url('imgProduct/6634dea5ce4a7.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="font-medium ml-4 ">Logitech Keyboard</div>
                                </td>
                                <td class="p-2 border dark:border-green-50">
                                    <div class="text-center">1</div>
                                </td>
                                <td class="p-2 border dark:border-green-50">
                                    <div class="text-center font-medium "> 120.50 €</div>
                                </td>
                                <td class="p-2 border dark:border-green-50">
                                    <div class="flex justify-center">
                                        <button>
                ...
                <div class="flex flex-row-reverse text-white pb-3">
                    <button class="rounded-full bg-blue-900 mx-6 p-2 w-20 ">Pagar</button>
