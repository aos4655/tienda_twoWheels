            ...
            <div class="bg-white h-fit dark:bg-blue-800 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="container px-5 py-24 mx-auto">
                        <div class="lg:w-4/5 mx-auto flex flex-wrap">
                            ...
                            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1 dark:text-white">{{ $producto->nombre }}
                                </h1>
                                <div class="flex mb-4">
                                    <span class="flex items-center">
                                        <svg fill="currentColor" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-blue-800 dark:text-white"
                                            viewBox="0 0 24 24">
                                            <path
                                        ...
                                        <span class="text-gray-600 ml-3 dark:text-white">4 reseñas</span>
                                    </span>
                                </div>
                                ...
                                <div class="flex  justify-between">
                                    <span class="title-font font-medium text-2xl text-gray-900 md:mt-5 dark:text-white">{{ $producto->precio }}
                                        €</span>
                                    @auth
                ...
                <section class="mb-8">
                    ...
                    <div class="flex flex-row ml-36 -mx-2 mt-7 justify-start items-center">
                        <p class="font-bold mr-5">Pepe el panadero</p>
                        <div class="flex ">
                            <span class="flex items-center">
                                <svg fill="currentColor" stroke="currentColor" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-blue-800 dark:text-white"
                    ...
                    <div class="flex ml-36 -mx-2 mt-3 w-3/4">
                        <blockquote>
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">"Flowbite is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for your next SaaS application."</p>
                        </blockquote>
                    </div>
                </section>
            </div>
