                        ...
                        <div
                            ...
                            <div class="lg:w-1/4 md:w-1/2 w-full px-4 justify-center">
                                ...
                                <nav class="list-none mb-10">
                                    <li>
                                        <a class="cursor-pointer" href="{{ route('terminos.show') }}">Aviso Legal y
                                            Terminos de uso</a>
                                    </li>
                                    <li>
                                        <a class="cursor-pointer" href="{{ route('politica.show') }}">Política de
                                            privacidad</a>
                                    </li>
                                </nav>
                            </div>
                            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                                ...
                                <nav class="list-none flex flex-row mb-10 mt-4">
                                    ...
                                    <li class="mx-auto md:mx-0">
                                        <a href="{{ route('contactanos.index') }}" onmouseenter="addAnimation('email')"
                                            onmouseleave="removeAnimation('email')"><i id="email"
                        ...
                        <div>
                            ...
                            <p xmlns:cc="http://creativecommons.org/ns#">Esta obra está licenciada bajo
                                <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1"
                                    target="_blank" rel="license noopener noreferrer" class="flex">CC
                                    BY-NC-SA 4.0
                        ...
                        <div class="flex justify-center space-x-4 mt-4 md:mt-0">
                            <div class="w-1/3  ">
                                <svg version="1.1" width="60" height="40" xmlns="http://www.w3.org/2000/svg"
                                    class="bg-gray-800 p-1 rounded-lg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 64 32" fill="white">
                                    <path
                            ...
                            <div class="w-1/3 ">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="60" height="40"
                                    ...
                                    class="bg-gray-800 p-1 rounded-lg" fill="white">
                                    <path
