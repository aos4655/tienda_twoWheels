                                ...
                                listItem.innerHTML = `
                                    ...
                                    <div class="flex flex-1 items-end justify-between text-sm">
                                        ...
                                        <div class="relative flex items-center max-w-[6rem]">
                                            ...
                                            <button type="button" id="increment-button" data-input-counter-increment="quantity-input" class="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-sm p-1.5 h-6 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-1.5 focus:outline-none">
