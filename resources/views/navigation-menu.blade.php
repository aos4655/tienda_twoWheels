                ...
                <div class="hidden sm:block sm:items-center sm:ms-6">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        @else
                            @if (Route::has('login'))
                                <a href="{{ route('login') }}"
                                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white  ">
                                    Acceder</a>

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-white  ">Registrarse</a>
                                @endif
                            @endif
                        @endauth
                    </div>
