<div>
    <button
        class="relative justify-start inline-flex items-center p-3 text-sm font-medium text-center rounded-lg focus:ring-4 focus:outline-none" wire:click="$set('abrirModalCart', true)">
        ...
        <x-slot name="content">
            @foreach ($this->productosUsuario as $producto)
                <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                    <input id="{{ $producto->id }}" type="checkbox" value="{{ $producto->id }}"
