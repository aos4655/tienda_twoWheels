    ...
    <div class="py-28 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white h-fit dark:bg-blue-800 overflow-hidden  shadow-xl sm:rounded-3xl">
            <div class="px-8 py-8">
                ...
                <p class="my-4 text-lg text-gray-500">Aquí podrás ver la información detallada de cada pedido</p>
            </div>
            <script>
                const fecha = {
            ...
            @foreach ($pedidos as $pedido)
                <div class="px-8 pb-8">
                    {{-- Para cada orden --}}
                    <div class="flex flex-row justify-between border rounded-t-lg bg-green-50 border-gray-200 py-3">
                        <div class="flex flex-col w-3/4 ">
                            <dl class="flex flex-row text-blue-900 ">
                                <div class="mx-10">
                                ...
                                <div class="mx-10">
                                    ...
                                    <dd class="text-gray-500"><time
                                            datetime="2021-07-06">{{ $pedido->created_at }}</time></dd>
                                </div>
                                <div class="mx-10">
                                ...
                                <div class="flex-row m-3 p-4">
                                    <div class="flex flex-row items-start">
                                        ...
                                        <div class="ml-4 w-3/4">
                                            <div class="flex justify-between">
                                                <h5 class="font-extrabold text-lg text-blue-900">{{ $producto->nombre }}</h5>
                                                <p>{{ $producto->precio }} €</p>
                                            </div>
                                    ...
                                    <div class="justify-between flex flex-row mt-3">
                                        <div class="flex flex-row items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#093564"
                                                aria-hidden="true" class="w-8">
                                                <path fill-rule="evenodd"
                                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"
                                                    clip-rule="evenodd"></path>
                                            </svg>
                                            <p class="ml-4 text-gray-500 ultimoEstado_{{ $pedido->id }}"></p>
                                        </div>
                                        <div class="flex flex-row items-center justify-center">
                                            <div class="mr-4">View product</div>
                                            <button
                                                onclick="aniadirCarrito({{ Auth::user()->id }}, {{ $producto->id }})"
                                                class="text-blue-900 relative overflow-hidden">
                                                Buy Again
                                            </button>
                                        </div>
                                    </div>
