    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4 relative">
            ...
            <div class="relative">
                ...
                <input type="number" id="num_telefono" wire:model="num_telefono"
                    aria-describedby="Introduzca el numero con el formato 111-111-111"
                    class=" border-gray-300 rounded-lg focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 block w-full ps-10 p-2.5  dark:bg-blue-950 dark:border-gray-600  dark:text-white s"
